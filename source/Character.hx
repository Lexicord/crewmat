	...
	public function new(x:Float, y:Float, ?character:String = "bf", ?isPlayer:Bool = false)
	{
		...
		switch (curCharacter)
		{
			...
			case 'green':
				...
				playAnim('idle');
			case 'mongus':
				tex = Paths.getSparrowAtlas('sus/augnous');
				frames = tex;
				animation.addByPrefix('idle', 'Idle', 24, false);
				animation.addByPrefix('singUP', 'Up', 24, false);
				animation.addByPrefix('singRIGHT', 'Right', 24, false);
				...
				addOffset('idle');
				addOffset("singUP", -30, 60);
				addOffset("singRIGHT", -60, -10);
				addOffset("singLEFT", 170, -10);
				addOffset("singDOWN", 2, 84);

				addOffset("singUpHOLD", -30, 60);
				addOffset("singRightHOLD", -60, -10);
				addOffset("singLeftHOLD", 170, -10);
				addOffset("singDownHOLD", 2, 84);
			...
			case 'sus':
				...
				addOffset("singUpHOLD", 80, 30);
				addOffset("singRightHOLD", -50, -10);
				addOffset("singLeftHOLD", 121, 0);
			...
			case 'wires':
				...
				addOffset('idle');
				addOffset("singUP", -16, 5);
				addOffset("singRIGHT", -16, 0);
				addOffset("singLEFT", -36, 27);
				addOffset("singDOWN", -34, 0);

				addOffset("singUpHOLD", -16, 5);
				addOffset("singRightHOLD", -16, 0);
				addOffset("singLeftHOLD", -36, 27);
				addOffset("singDownHOLD", -34, 0);
			...
			case 'impostor':
				...
				addOffset("singUpHOLD");
				addOffset("singRightHOLD");
				addOffset("singLeftHOLD");
				addOffset("singDownHOLD");
			...
			case 'bf':
				...
				animation.addByPrefix('singeject', 'BF Eject', 24, true);
